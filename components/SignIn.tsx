...
// import { setUserLoggedIn } from "@/store/cartSlice";
...
//       {user ? (
//         <main className="absolute z-500 flex flex-col gap-4 bg-white -top-3 right-38 border-gray-300 border-1 rounded-[10px] p-4 w-[20rem] h-[14rem] ">
//           <div className="flex items-center  gap-3">
//             <span className="h-8 w-8 flex items-center justify-center text-white font-medium rounded-full bg-primary">
//               {user?.email ? user.email.charAt(0).toUpperCase() : ""}
//             </span>
//             <div>
//               <h4 className="text-[14px] p-0 m-0 font-medium">{user?.name ? user.name : ""}</h4>
...
//           <section
//             className="w-[400px] relative min-h-[80lvh]  bg-red-900 text-white flex flex-col gap-4 rounded-xl px-6 py-9 shadow-xl"
//           >
//             <span
